#!/usr/bin/env python3
"""
Benchmark fuzzylogs throughput: lines/s per worker count for a fixed file size.
Markov chain is built once and excluded from timing.

Usage:
    python tests/benchmark_workers.py [--lines 100000] [--dict-path /usr/share/dict/words]
"""
